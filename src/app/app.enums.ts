...
export enum APP_STRINGS {
  ...
  REQUEST_TIMED_OUT_TITLE = 'Request timed out',
  REQUEST_TIMED_OUT_MESSAGE = 'Unable to end visit, check connectivity and try again',
  ...
  FAILED_MESSAGE_END_VISIT_ONE = 'Site visit has failed to submit, contact IT support.',
  FAILED_MESSAGE_END_VISIT_TWO = 'Once you have contacted IT it may take time to close the visit.',
  FAILED_MESSAGE_END_VISIT_THREE = 'You will not be able to start a new visit until this visit is closed.',
...
export enum PAGE_NAMES {
  ...
  SITE_VISIT_FAILED_PAGE = 'SiteVisitFailedPage',
...
export enum ANALYTICS_VALUE {
  ...
  WAIT_ACTIVITY_SUBMISSION_FAILED = 'Wait activity submission failed',
  START_ACTIVITY_FAILED = 'Starting activity failed',
