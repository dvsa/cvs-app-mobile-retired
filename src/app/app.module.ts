...
import { VaultService } from '../providers/auth/vault/vault.service';
import { BrowserAuthPlugin } from '../providers/auth/browser-auth/brower-auth.plugin';
import { BrowserAuthService } from '../providers/auth/browser-auth/browser-auth.service';
