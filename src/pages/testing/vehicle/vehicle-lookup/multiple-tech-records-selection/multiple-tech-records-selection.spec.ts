...
import {IonicModule, LoadingController, NavController, NavParams, ViewController} from 'ionic-angular';
import { NavParamsMock } from "../../../../../../test-config/ionic-mocks/nav-params.mock";
import { CUSTOM_ELEMENTS_SCHEMA } from "@angular/core";
import {LoadingControllerMock, NavControllerMock, ViewControllerMock} from 'ionic-mocks';
...
describe('Component: ', () => {
  ...
  it('should open the vehicle details page if the call to test-results is successful', () => {
    ...
    expect(navCtrl.push).toHaveBeenCalledWith(PAGE_NAMES.VEHICLE_DETAILS_PAGE, {test: undefined, vehicle: VehicleDataMock.VehicleData});
  });
