...
export class VehicleLookupSearchCriteriaSelectionPage implements OnInit {
  ...
  ngOnInit(): void {
    this.searchCriteriaList = this.trailersOnly ? this.getFormattedSearchCriteriaList(VehicleLookupSearchCriteriaData.VehicleLookupSearchCriteriaTrailersOnly) : this.getFormattedSearchCriteriaList(VehicleLookupSearchCriteriaData.VehicleLookupSearchCriteria);
  }

  getFormattedSearchCriteriaList(notFormattedSearchCriteriaList: string[]): SearchCriteriaItemModel[] {
