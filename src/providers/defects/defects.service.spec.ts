...
describe('Provider: DefectsService', () => {
  ...
  it('should create defect based on isAdvisory: true', () => {
    ...
    let defect = defectsService.createDefect(defCat, defItem, deficiency, vehicleType, isAdvisory);
  ...
  it('should sort an aray based on key and order', () => {
    ...
    let sortedDefectsArray = defectsService.orderDefectsArray(defectsArray, 'imDescription', 'desc');
