...
describe('Provider: FirebaseLogsService', () => {
  ...
  it('should call firebase.logEvent with 4 parameters', () => {
    ...
    firebaseLogsService.logEvent(eventName,
      testParametersKeys[0], testParameters.parameter0,
      testParametersKeys[1], testParameters.parameter1,
      testParametersKeys[2], testParameters.parameter2,
      testParametersKeys[3], testParameters.parameter3);
  ...
  it('should check if firebase.logEvent was called', () => {
    ...
    expect(firebase.logEvent).toHaveBeenCalled();
    firebaseLogsService.logEvent('somestring', 'somestring', 'somestring', 'somestring', 'somestring', 'somestring', 'somestring');
    expect(firebase.logEvent).toHaveBeenCalled();
  });
