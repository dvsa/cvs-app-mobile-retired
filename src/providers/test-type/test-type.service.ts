...
export class TestTypeService {
  ...
  private logFirebaseAddDefect(deficiencyRef: string) {
    ...
    parameters[FIREBASE_DEFECTS.ADD_DEFECT_TIME_TAKEN] = this.firebaseLogsService.differenceInSeconds(parameters[FIREBASE_DEFECTS.ADD_DEFECT_START_TIME], parameters[FIREBASE_DEFECTS.ADD_DEFECT_END_TIME])
